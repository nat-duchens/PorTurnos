...
export const orders = [
  { id: 101, product: 'Dixit', buyer: 'Ana García', date: '15/08/2025', price: 18, status: 'completed' },
  { id: 102, product: 'Monopoly', buyer: 'Carlos Ruiz', date: '18/08/2025', price: 15, status: 'shipped' },
  { id: 103, product: 'Risk', buyer: 'Elena Martín', date: '20/08/2025', price: 22, status: 'pending' }
];

export const messages = [
  { id: 201, from: 'Ana García', subject: 'Consulta sobre Dixit', date: '14/08/2025', read: true },
  { id: 202, from: 'Carlos Ruiz', subject: 'Pregunta sobre envío', date: '19/08/2025', read: true },
  { id: 203, from: 'Elena Martín', subject: 'Disponibilidad de Risk', date: '21/08/2025', read: false },
  { id: 204, from: 'Juan Pérez', subject: 'Interesado en Catan', date: '12/08/2025', read: false }
];
